...
public:
    ...
    Task(const QString &smallServerUrl, QWidget *parent, QString task_name, QString task_text, int task_id); // Конструктор с названием и текстом
...
private:
    int task_id; // Член класса для хранения id таска
